...
<body>
	<nav class="navbar navbar-default fixed">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#chefes">Chefes</a></li>
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-haspopup="true"
	...
	<header>
		<div class="col-xs-5 col-sm-3 col-md-2">
			<img src=<c:url value="/resources/image/nome.png"/>
	...
	<section class="col-xs-12">
		<div
			class="produtosDestaque col-sm-offset-1 col-sm-10 col-sm-offset-1"
			id="destaque">
			...
			<div class="row topo">
				<div class="col-sm-5 bloco">
					...
					<br>
					<p>
						<i class="fas fa-check"></i> Molho, tomate, mussarela, pepperoni,
						orégano
					</p>
					<p>
						<i class="far fa-clock"></i> Tempo Preparo: 40 min
					</p>
				</div>
				<div class="col-sm-5 col-sm-offset-2">
					<img src=<c:url value="/resources/image/americana.jpg"/>
			...
			<div class="row">
				<div class="col-sm-5 bloco">
					...
					<br>
					<p>
						<i class="fas fa-check"></i> Molho, mussarela, calabresa, cebola
						fatiada e orégano.
					</p>
					<p>
						<i class="far fa-clock"></i> Tempo Preparo: 45 min
					</p>
				</div>
				<div class="col-sm-5 col-sm-offset-2">
					<img src=<c:url value="/resources/image/pizza.jpg"/>
						class="img-responsive img-thumbnail">
				</div>
			</div>
			<div class="row">
				<div class="col-sm-5 bloco">
					...
					<br>
					<p>
						<i class="fas fa-check"></i> Molho, mussarela, milho, bacon,
						parmesão e orégano.…
					</p>
					<p>
						<i class="far fa-clock"></i> Tempo Preparo: 40 min
				...
				<div class="col-sm-5 col-sm-offset-2">
					<img src=<c:url value="/resources/image/BaconMilho.jpg"/>
						class="img-responsive img-thumbnail">
				</div>
			</div>
			<div class="row">
				<div class="col-sm-5 bloco">
					...
					<br>
					<p>
						<i class="fas fa-check"></i> Molho, mussarela, Frango ao molho e
						orégano.
					</p>
					<p>
						<i class="far fa-clock"></i> Tempo Preparo: 40 min
				...
				<div class="col-sm-5 col-sm-offset-2">
					<img src=<c:url value="/resources/image/Frango.jpg"/>
						class="img-responsive img-thumbnail">
				</div>
			</div>
			<div class="row">
				<div class="col-sm-5 bloco">
					...
					<br>
					<p>
						<i class="fas fa-check"></i> Molho, mussarela, presunto,
						calabresa, ovos, cebola, azeitonas e orégano.
					</p>
					<p>
						<i class="far fa-clock"></i> Tempo Preparo: 40 min
					</p>
				...
				<div class="col-sm-5 col-sm-offset-2">
					<img src=<c:url value="/resources/image/Portuguesa.jpg"/>
						class="img-responsive img-thumbnail">
				</div>
			</div>
			<div class="row">
				<div class="col-sm-5 bloco">
					...
					<br>
					<p>
						<i class="fas fa-check"></i> Molho, mussarela, brócolis, palmito,
						tomate, champignon, cebola e orégano.
					</p>
					<p>
						<i class="far fa-clock"></i> Tempo Preparo: 45 min.
					</p>
				...
				<div class="col-sm-5 col-sm-offset-2">
					<img src=<c:url value="/resources/image/vegetariana.jpg"/>
						class="img-responsive img-thumbnail">
				</div>
			</div>
			<div class="row">
				<div class="col-sm-5 bloco">
					...
					<br>
					<p>
						<i class="fas fa-check"></i> Mussarela, chocolate ao leite e
						morango.
					</p>
					<p>
						<i class="far fa-clock"></i> Tempo Preparo: 30 min.
					</p>
				</div>
				<div class="col-sm-5 col-sm-offset-2">
					<img src=<c:url value="/resources/image/Chocolate.jpg"/>
						class="img-responsive img-thumbnail">
				</div>
			</div>
		</div>
		...
		<div class="produtosDestaque col-sm-12" id="chefes">
			...
			<div class="row">
				<div class=" col-sm-4 bloco">
					...
					<br> <img src=<c:url value="/resources/image/fogaca.jpg"/>
						class="img-responsive img-rounded">
				</div>
				<div class=" col-sm-4 bloco">
					<h2 class="text-center">Paola</h2>
					<br> <img src=<c:url value="/resources/image/paola.jpg"/>
						class="img-responsive img-rounded">
				</div>
				<div class=" col-sm-4 bloco">
					<h2 class="text-center">Jacquin</h2>
					<br> <img src=<c:url value="/resources/image/jacan.jpg"/>
						class="img-responsive 	img-rounded">
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-12" id="contato">
					...
					<dl>
						<dt>Email:</dt>
						<dd>
							<a href="mailto:#">kasanovapizzaria@gmail.com</a>
						</dd>
					</dl>
					<dl>
						<dt>Phones:</dt>
						<dd>
							<a href="tel:#">+99 99966-6333</a> <span>or</span> <a
								href="tel:#">+99 22255-5888</a>
						</dd>
					</dl>
				</div>
			</div>
