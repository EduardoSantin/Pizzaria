...
<div
	class="container col-xs-offset-1 col-xs-10 col-md-offset-2 col-md-8">
...
<div class="container col-xs-12" style="margin-bottom: 20px;">
	<form action='<c:url value="/pedido/finalizarEntrega"/>' method="post">
		...
		<div
			class="col-xs-offset-2 col-xs-8 col-md-offset-1 col-md-4 text-center form-group">
		...
		<div id="opcao">
			...
			<div class="col-xs-offset-2 col-xs-8 col-md-4 text-center form-group">
				<label>Endereço</label> <input class="form-control" type="text"
					name="endereco" placeholder="Endereço" value="${endereco}"
					required="required" />
			</div>
			<div
				class="col-xs-offset-2 col-xs-8  col-md-offset-1 col-md-4 text-center form-group">
				<label>Bairro</label> <input class="form-control" type="text"
					name="bairro" placeholder="Bairro" value="${bairro}"
					required="required" />
			</div>
			<div class="col-xs-offset-2 col-xs-8 col-md-4 text-center form-group">
				<label>Cidade</label> <input class="form-control" type="text"
					name="cidade" placeholder="Cidade" value="${cidade}"
					required="required" />
			</div>
			<div
				class="col-xs-offset-2 col-xs-8 col-md-offset-1 col-md-4 text-center form-group">
				<label>Numero</label> <input class="form-control" type="text"
					name="numero" placeholder="Numero" value="${numero}" />
			</div>
			<br>
		</div>
		<div class="col-xs-offset-2 col-xs-8 text-center">
			<br>
			<button type="submit" class="btn btn-success" data-toggle="modal" data-target="#myModal">Enviar Pedido</button>
		</div>
		<!-- 
		...
		<div class="col-xs-offset-2 col-xs-8 col-md-offset-1 col-md-4 radio text-center">
			<strong><label>Retirada/Entrega</label></strong> <br> <input
				type="checkbox" id="local" name="local" onclick="bloqueio()">No
			local</label>
		</div>
		<div class="col-xs-offset-2 col-xs-8 text-center">
			<br>
			<button type="button" class="btn btn-primary" data-toggle="modal"
				data-target="#myModal">Salvar Pedido</button>
		</div>
		 -->
	</form>
</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="submit" class="btn btn-info" data-dismiss="modal">Confirmar</button>
			</div>
		</div>
	</div>
</div>